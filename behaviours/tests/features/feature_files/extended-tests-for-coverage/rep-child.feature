@coverage
Feature: rep-foster-carer.applicant-child-under-12 email extended coverage journey
...
And the user answers "01 01 2025" to the question "q-applicant-enter-your-date-of-birth"
When the user continues
...
And the user answers 'support' to the question "q-rep-first-name"
And the user answers 'org' to the question "q-rep-last-name"
When the user continues
...
And the user answers 'support' to the question "q-rep-organisation-name"
...
When the user continues
Then the user is on page "p-applicant-select-infections"

Scenario: the user is on page p-applicant-select-infections.
Given the user is on page "p-applicant-select-infections"
