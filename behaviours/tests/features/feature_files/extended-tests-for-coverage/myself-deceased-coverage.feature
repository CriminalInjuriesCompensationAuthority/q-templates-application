@coverage
Feature: applicant:adult.deceased full claim email extended coverage journey
...
And the user answers 'regular' to the question "q-applicant-contact-with-deceased"
When the user continues
...
And the user answers 'false' to the question "q-applicant-living-together-duration"
When the user continues
...
And the user answers 'false' to the question "q-other-claimants"
When the user continues
