...
And the user answers 'muscle' to the question "q-applicant-physical-injury-upper"
When the user continues
Then the user is on page "p-applicant-physical-injury-upper-muscle"


Scenario: the user is on page p-applicant-physical-injury-upper-muscle.
Given the user is on page "p-applicant-physical-injury-upper-muscle"
And the user answers 'phyinj-151' to the question "q-applicant-physical-injuries"
When the user continues
