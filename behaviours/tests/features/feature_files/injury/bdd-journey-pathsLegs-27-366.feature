...
When the user continues
Then the user is on page "p-applicant-physical-injury-legs-skin"


Scenario: the user is on page p-applicant-physical-injury-legs-skin.
Given the user is on page "p-applicant-physical-injury-legs-skin"
And the user answers 'phyinj-134' to the question "q-applicant-physical-injuries"
When the user continues
