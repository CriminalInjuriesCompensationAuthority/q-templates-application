...
And the user answers 'face' to the question "q-applicant-physical-injury-upper"
When the user continues
Then the user is on page "p-applicant-physical-injury-upper-face"


Scenario: the user is on page p-applicant-physical-injury-upper-face.
Given the user is on page "p-applicant-physical-injury-upper-face"
And the user answers 'phyinj-030' to the question "q-applicant-physical-injuries"
When the user continues
