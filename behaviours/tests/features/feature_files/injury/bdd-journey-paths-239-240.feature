...
And the user answers 'digit' to the question "q-applicant-physical-injury-arms"
When the user continues
Then the user is on page "p-applicant-physical-injury-arms-digit"


Scenario: the user is on page p-applicant-physical-injury-arms-digit.
Given the user is on page "p-applicant-physical-injury-arms-digit"
And the user answers 'phyinj-110' to the question "q-applicant-physical-injuries"
When the user continues
