...
And the user answers 'eye' to the question "q-applicant-physical-injury-upper"
When the user continues
Then the user is on page "p-applicant-physical-injury-upper-eye"


Scenario: the user is on page p-applicant-physical-injury-upper-eye.
Given the user is on page "p-applicant-physical-injury-upper-eye"
And the user answers 'phyinj-028' to the question "q-applicant-physical-injuries"
When the user continues
