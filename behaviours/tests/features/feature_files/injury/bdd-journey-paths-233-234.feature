...
And the user answers 'muscle' to the question "q-applicant-physical-injury-torso"
When the user continues
Then the user is on page "p-applicant-physical-injury-torso-muscle"


Scenario: the user is on page p-applicant-physical-injury-torso-muscle.
Given the user is on page "p-applicant-physical-injury-torso-muscle"
And the user answers 'phyinj-154' to the question "q-applicant-physical-injuries"
When the user continues
