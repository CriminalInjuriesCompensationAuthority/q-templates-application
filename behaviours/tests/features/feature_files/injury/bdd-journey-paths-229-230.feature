...
And the user answers 'back' to the question "q-applicant-physical-injury-torso"
When the user continues
Then the user is on page "p-applicant-physical-injury-torso-back"


Scenario: the user is on page p-applicant-physical-injury-torso-back.
Given the user is on page "p-applicant-physical-injury-torso-back"
And the user answers 'phyinj-064' to the question "q-applicant-physical-injuries"
When the user continues
