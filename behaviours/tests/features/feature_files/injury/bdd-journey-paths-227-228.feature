...
And the user answers 'chest' to the question "q-applicant-physical-injury-torso"
When the user continues
Then the user is on page "p-applicant-physical-injury-torso-chest"


Scenario: the user is on page p-applicant-physical-injury-torso-chest.
Given the user is on page "p-applicant-physical-injury-torso-chest"
And the user answers 'phyinj-072' to the question "q-applicant-physical-injuries"
When the user continues
