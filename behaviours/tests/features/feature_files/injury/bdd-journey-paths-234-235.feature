...
And the user answers 'shoulder' to the question "q-applicant-physical-injury-arms"
When the user continues
Then the user is on page "p-applicant-physical-injury-arms-shoulder"


Scenario: the user is on page p-applicant-physical-injury-arms-shoulder.
Given the user is on page "p-applicant-physical-injury-arms-shoulder"
And the user answers 'phyinj-076' to the question "q-applicant-physical-injuries"
When the user continues
