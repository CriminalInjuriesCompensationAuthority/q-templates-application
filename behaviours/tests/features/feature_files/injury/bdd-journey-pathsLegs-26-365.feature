...
And the user answers 'toes' to the question "q-applicant-physical-injury-legs"
And the user answers 'muscle' to the question "q-applicant-physical-injury-legs"
When the user continues
Then the user is on page "p-applicant-physical-injury-legs-toes"


Scenario: the user is on page p-applicant-physical-injury-legs-toes.
Given the user is on page "p-applicant-physical-injury-legs-toes"
And the user answers 'phyinj-129' to the question "q-applicant-physical-injuries"
When the user continues
