...
And the user answers 'leg' to the question "q-applicant-physical-injury-legs"
And the user answers 'muscle' to the question "q-applicant-physical-injury-legs"
When the user continues
Then the user is on page "p-applicant-physical-injury-legs-leg"


Scenario: the user is on page p-applicant-physical-injury-legs-leg.
Given the user is on page "p-applicant-physical-injury-legs-leg"
And the user answers 'phyinj-117' to the question "q-applicant-physical-injuries"
When the user continues
