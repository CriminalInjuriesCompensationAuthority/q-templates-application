...
And the user answers 'ear' to the question "q-applicant-physical-injury-upper"
When the user continues
Then the user is on page "p-applicant-physical-injury-upper-ear"


Scenario: the user is on page p-applicant-physical-injury-upper-ear.
Given the user is on page "p-applicant-physical-injury-upper-ear"
And the user answers 'phyinj-012' to the question "q-applicant-physical-injuries"
When the user continues
