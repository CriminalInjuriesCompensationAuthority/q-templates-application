...
And the user answers 'hand' to the question "q-applicant-physical-injury-arms"
When the user continues
Then the user is on page "p-applicant-physical-injury-arms-hand"


Scenario: the user is on page p-applicant-physical-injury-arms-hand.
Given the user is on page "p-applicant-physical-injury-arms-hand"
And the user answers 'phyinj-096' to the question "q-applicant-physical-injuries"
When the user continues
