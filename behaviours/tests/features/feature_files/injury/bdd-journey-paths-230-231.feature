...
And the user answers 'pelvis' to the question "q-applicant-physical-injury-torso"
When the user continues
Then the user is on page "p-applicant-physical-injury-torso-pelvis"


Scenario: the user is on page p-applicant-physical-injury-torso-pelvis.
Given the user is on page "p-applicant-physical-injury-torso-pelvis"
And the user answers 'phyinj-074' to the question "q-applicant-physical-injuries"
When the user continues
