...
And the user answers 'ankle' to the question "q-applicant-physical-injury-legs"
And the user answers 'muscle' to the question "q-applicant-physical-injury-legs"
When the user continues
Then the user is on page "p-applicant-physical-injury-legs-ankle"


Scenario: the user is on page p-applicant-physical-injury-legs-ankle.
Given the user is on page "p-applicant-physical-injury-legs-ankle"
And the user answers 'phyinj-114' to the question "q-applicant-physical-injuries"
When the user continues
Then the user is on page "p-applicant-physical-injury-legs-muscle"


Scenario: the user is on page p-applicant-physical-injury-legs-muscle.
Given the user is on page "p-applicant-physical-injury-legs-muscle"
And the user answers 'phyinj-164' to the question "q-applicant-physical-injuries"
When the user continues
