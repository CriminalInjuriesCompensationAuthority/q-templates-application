...
And the user answers 'arm' to the question "q-applicant-physical-injury-arms"
When the user continues
Then the user is on page "p-applicant-physical-injury-arms-arm"


Scenario: the user is on page p-applicant-physical-injury-arms-arm.
Given the user is on page "p-applicant-physical-injury-arms-arm"
And the user answers 'phyinj-099' to the question "q-applicant-physical-injuries"
When the user continues
