...
And the user answers 'skin' to the question "q-applicant-physical-injury-torso"
When the user continues
Then the user is on page "p-applicant-physical-injury-torso-skin"


Scenario: the user is on page p-applicant-physical-injury-torso-skin.
Given the user is on page "p-applicant-physical-injury-torso-skin"
And the user answers 'phyinj-054' to the question "q-applicant-physical-injuries"
When the user continues
