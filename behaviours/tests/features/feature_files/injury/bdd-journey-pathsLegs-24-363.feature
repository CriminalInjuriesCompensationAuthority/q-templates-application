...
And the user answers 'foot' to the question "q-applicant-physical-injury-legs"
And the user answers 'muscle' to the question "q-applicant-physical-injury-legs"
When the user continues
Then the user is on page "p-applicant-physical-injury-legs-foot"


Scenario: the user is on page p-applicant-physical-injury-legs-foot.
Given the user is on page "p-applicant-physical-injury-legs-foot"
And the user answers 'phyinj-118' to the question "q-applicant-physical-injuries"
When the user continues
