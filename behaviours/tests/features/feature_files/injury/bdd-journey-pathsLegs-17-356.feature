...
And the user answers 'knee' to the question "q-applicant-physical-injury-legs"
And the user answers 'muscle' to the question "q-applicant-physical-injury-legs"
When the user continues
Then the user is on page "p-applicant-physical-injury-legs-knee"


Scenario: the user is on page p-applicant-physical-injury-legs-knee.
Given the user is on page "p-applicant-physical-injury-legs-knee"
And the user answers 'phyinj-123' to the question "q-applicant-physical-injuries"
When the user continues
