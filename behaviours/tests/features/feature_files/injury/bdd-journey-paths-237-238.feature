...
And the user answers 'wrist' to the question "q-applicant-physical-injury-arms"
When the user continues
Then the user is on page "p-applicant-physical-injury-arms-wrist"


Scenario: the user is on page p-applicant-physical-injury-arms-wrist.
Given the user is on page "p-applicant-physical-injury-arms-wrist"
And the user answers 'phyinj-104' to the question "q-applicant-physical-injuries"
When the user continues
