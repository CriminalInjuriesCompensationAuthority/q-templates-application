...
And the user answers 'neck' to the question "q-applicant-physical-injury-upper"
When the user continues
Then the user is on page "p-applicant-physical-injury-upper-neck"


Scenario: the user is on page p-applicant-physical-injury-upper-neck.
Given the user is on page "p-applicant-physical-injury-upper-neck"
And the user answers 'phyinj-039' to the question "q-applicant-physical-injuries"
When the user continues
