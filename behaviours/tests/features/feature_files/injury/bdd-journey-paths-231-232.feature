...
And the user answers 'legs' to the question "q-applicant-physical-injury"
When the user continues
...
And the user answers 'genitals' to the question "q-applicant-physical-injury-torso"
When the user continues
Then the user is on page "p-applicant-physical-injury-torso-genitals"


Scenario: the user is on page p-applicant-physical-injury-torso-genitals.
Given the user is on page "p-applicant-physical-injury-torso-genitals"
And the user answers 'phyinj-066' to the question "q-applicant-physical-injuries"
When the user continues
Then the user is on page "p-applicant-physical-injury-legs"


Scenario: the user is on page p-applicant-physical-injury-legs.
Given the user is on page "p-applicant-physical-injury-legs"
And the user answers 'hip' to the question "q-applicant-physical-injury-legs"
When the user continues
Then the user is on page "p-applicant-physical-injury-legs-hip"


Scenario: the user is on page p-applicant-physical-injury-legs-hip.
Given the user is on page "p-applicant-physical-injury-legs-hip"
And the user answers 'phyinj-120' to the question "q-applicant-physical-injuries"
When the user continues
