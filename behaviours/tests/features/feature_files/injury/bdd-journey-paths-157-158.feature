...
And the user answers 'nose' to the question "q-applicant-physical-injury-upper"
When the user continues
Then the user is on page "p-applicant-physical-injury-upper-nose"


Scenario: the user is on page p-applicant-physical-injury-upper-nose.
Given the user is on page "p-applicant-physical-injury-upper-nose"
And the user answers 'phyinj-032' to the question "q-applicant-physical-injuries"
When the user continues
