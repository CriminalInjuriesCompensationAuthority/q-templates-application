@mainapplicant-applicant-child-under-12-email-postcode-lookup @postcode-lookup
...
And the user answers 'i-agree-under-12' to the question "q-applicant-declaration"
