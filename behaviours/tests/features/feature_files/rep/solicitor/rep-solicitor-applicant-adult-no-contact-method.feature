@rep-solicitor-applicant-adult-no-contact-method @legacy @rep @solicitor
...
When the user continues
Then the user is on page "p-applicant-unable-to-work-duration"

Scenario: the user is on page p-applicant-unable-to-work-duration.
Given the user is on page "p-applicant-unable-to-work-duration"
...
When the user advances the application
Then the user is on page "p-rep-declaration-12-and-over"

Scenario: the user is on page p-rep-declaration-12-and-over.
Given the user is on page "p-rep-declaration-12-and-over"
