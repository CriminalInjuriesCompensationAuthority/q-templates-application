@rep-no-legal-authority-applicant-adult-incapable-deceased-full-claim-email @legacy @rep @claims-mgt
...
And the user answers "01 01 1980" to the question "q-applicant-enter-your-date-of-birth"
When the user continues
...
And the user answers 'no' to the question "q--has-legal-authority"
When the user continues
...
When the user continues
Then the user is on page "p-rep-claims-management-reg"

Scenario: the user is on page p-rep-claims-management-reg.
Given the user is on page "p-rep-claims-management-reg"
...
When the user advances the application
Then the user is on page "p-rep-declaration-no-legal-authority-deceased"

Scenario: the user is on page p-rep-declaration-no-legal-authority-deceased.
Given the user is on page "p-rep-declaration-no-legal-authority-deceased"
