@rep-friend-or-relative-applicant-adult-incapable-deceased-full-claim-email @legacy @rep @friend-or-relative
...
Scenario: the user is on page p-mainapplicant-relationship.
Given the user is on page "p-mainapplicant-relationship"
And the user answers 'FRFA' to the question "q-applicant-british-citizen"
When the user continues
Then the user is on page "p-task-list"
