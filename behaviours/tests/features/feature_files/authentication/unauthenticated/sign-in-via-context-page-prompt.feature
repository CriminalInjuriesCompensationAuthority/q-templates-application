@Journey-for-unauthenticated-user-signing-in-via-context-page-prompt @authentication
Feature: Journey for unauthenticated user signing in via context-page-prompt
...
And the user answers 'redirect' to the question "q-new-application"
When the user continues
