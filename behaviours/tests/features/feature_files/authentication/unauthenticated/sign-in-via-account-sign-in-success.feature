@Journey-for-unauthenticated-user-signing-in-via-sign-in-success-with-referrer @authentication
Feature: Journey for unauthenticated user signing in via sign-in/success with referrer
...
And the user navigates to page "/account/sign-in/success"
