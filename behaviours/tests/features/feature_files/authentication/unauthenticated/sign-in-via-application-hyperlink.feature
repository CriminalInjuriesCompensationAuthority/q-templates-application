@Journey-for-unauthenticated-user-signing-via-hyperlink @authentication
Feature: Journey for unauthenticated user signing in via hyperlink
...
Scenario: the user clicks the signin link
