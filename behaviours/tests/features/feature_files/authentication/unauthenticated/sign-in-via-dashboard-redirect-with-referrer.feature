@Journey-for-unauthenticated-user-signing-in-via-dashboard-referrer @authentication
Feature: Journey for unauthenticated user signing in via going to /account/dashboard with referrer
...
Scenario: the user goes to /account/dashboard
