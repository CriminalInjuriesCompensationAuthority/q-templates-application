@broken-ethmoid @speedbump
Feature: applicant adult sms speedbump surfaced for perforated eardrum
...
Scenario: The user is telling us they have a broken ethmoid
Given the user is on page "p-applicant-physical-injury-upper-nose"
And the user answers 'phyinj-031' ("broken ethmoid") to the question 'q-applicant-physical-injuries'
When the user continues 
