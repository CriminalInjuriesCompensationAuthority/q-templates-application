...
And selects 'nose' to the question 'What parts of the head, face or neck were injured?'
When the user continues 
They will be on page "p-applicant-physical-injuries-upper-nose"
...
And selects 'phyinj-031' ("broken ethmoid") to the question 'Select any injuries to the nose'
When the user continues 
They will be on page "p-applicant-infections"

Scenario: The user is does not select an injury type
Given the user is on page "p-applicant-physical-injuries-upper-nose"
And does not select an answer to the question 'Select any injuries to the nose'
When the user continues 
They will see the error message 'Select an injury from the list'
