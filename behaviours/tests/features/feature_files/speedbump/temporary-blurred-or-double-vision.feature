Feature: applicant adult sms speedbump surfaced for temporary or blurred double vision
...
And selects 'Eye or eyesight' to the question 'What parts of the head, face or neck were injured?'
When the user continues 
They will be on page "p-applicant-physical-injuries-upper-eye"
...
Scenario: The user is telling us they have temporary blurred or double vision
Given the user is on page "p-applicant-physical-injuries-upper-eye"
And selects 'phyinj-014' ("temporary blurred or double vision") to the question 'Select any injuries to the eye or eyesight'
When the user continues 
They will be on page "p-applicant-infections"

Scenario: The user is does not select an injury type
Given the user is on page "p-applicant-physical-injuries-upper-eye"
And does not select an answer to the question 'Select any injuries to the eye or eyesight'
When the user continues 
They will see the error message 'Select an injury from the list'
