@temporary-blurred-or-double-vision @speedbump
...
And the user answers 'phyinj-014' ("temporary blurred or double vision") to the question 'q-applicant-physical-injuries'
When the user continues 
