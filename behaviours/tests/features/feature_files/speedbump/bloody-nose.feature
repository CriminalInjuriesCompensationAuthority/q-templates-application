@bloody-nose @speedbump
Feature: applicant adult sms speedbump surfaced for bloody nose
...
And the user answers 'phyinj-052' ("bloody nose") to the question 'q-applicant-physical-injuries'
When the user continues 
