@loss-of-fingernail @speedbump
Feature: applicant adult sms speedbump surfaced for loss of fingernail
...
And the user answers 'digit' ('Finger or thumb') to the question 'q-applicant-physical-injury-arms'
When the user continues 
Then the user is on page "p-applicant-physical-injury-arms-digit"

Scenario: The user is telling us they have lost their fingernail
Given the user is on page "p-applicant-physical-injury-arms-digit"
And the user answers 'phyinj-106' ("loss of fingernail") to the question 'q-applicant-physical-injuries'
When the user continues 
