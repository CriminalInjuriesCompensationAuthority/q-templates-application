...
When the user continues 
They will be on page "p-applicant-physical-injuries-torso-skin"

Scenario: The user is telling us they have bruises on their torso
Given the user is on page "p-applicant-physical-injuries-torso-skin"
And the user answers 'phyinj-080' ("bruises on torso") to the question 'q-applicant-physical-injuries-torso-skin-other'
When the user continues 
