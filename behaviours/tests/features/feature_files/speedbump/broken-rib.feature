Feature: applicant adult sms speedbump surfaced for broken rib
...
Scenario: The user is telling us their chest was injured
...
When the user continues 
They will be on page "p-applicant-physical-injuries-torso-chest"

Scenario: The user is telling us they have a broken rib
Given the user is on page "p-applicant-physical-injuries-torso-chest"
And the user answers 'phyinj-075' ("broken rib") to the question 'q-applicant-physical-injuries-torso-chest-other'
When the user continues 
