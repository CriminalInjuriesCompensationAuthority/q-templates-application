Feature: applicant adult sms speedbump surfaced for cuts on torso
...
Scenario: The user is telling us they have cuts on torso
Given the user is on page "p-applicant-physical-injuries-torso-skin"
And the user answers 'phyinj-079' ("cuts on torso") to the question 'q-applicant-physical-injuries-torso-skin-other'
When the user continues 
