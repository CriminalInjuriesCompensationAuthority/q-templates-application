@broken-toe @speedbump
Feature: applicant adult sms speedbump surfaced for broken toe
...
Scenario: The user is telling us they had a broken toe
Given the user is on page "p-applicant-physical-injury-legs-toes"
And the user answers 'phyinj-130' ("broken toe") to the question 'q-applicant-physical-injuries'
When the user continues 
