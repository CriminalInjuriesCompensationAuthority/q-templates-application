...
And the user answers 'ear' ('Ear or hearing') to the question 'q-applicant-physical-injury-upper'
When the user continues 
...
And the user answers 'phyinj-006' ('Broken ear bone') to the question 'q-applicant-physical-injuries'
When the user continues 
