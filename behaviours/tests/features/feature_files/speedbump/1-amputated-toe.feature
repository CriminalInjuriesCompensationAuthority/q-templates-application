@one-amputated-toe @speedbump
Feature: applicant adult sms speedbump surfaced for amputated toe
...
And the user answers 'legs' ('legs or feet') to the question "q-applicant-physical-injury"
When the user continues 
Then the user is on page "p-applicant-physical-injury-legs"

Scenario: The user is telling us their toes were injured
...
Scenario: The user is telling us they had an amputated toe
Given the user is on page "p-applicant-physical-injury-legs-toes"
And the user answers 'phyinj-132' ("1 amputated toe") to the question 'q-applicant-physical-injuries'
When the user continues 
...
Scenario: The user is on page p--context-injuries-not-eligible
