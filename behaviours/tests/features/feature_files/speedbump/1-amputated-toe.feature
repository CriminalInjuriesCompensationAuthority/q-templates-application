...
When the user continues 
Then the user is on page "p-applicant-physical-injuries-legs-toes"

Scenario: The user is telling us they had an amputated toe
Given the user is on page "p-applicant-physical-injuries-legs-toes"
And the user answers 'phyinj-132' ("1 amputated toe") to the question 'q-applicant-physical-injuries-legs-toes-other'
When the user continues 
