@keyhole-surgery-to-leg @speedbump
Feature: applicant adult sms speedbump surfaced for keyhole surgery to leg
...
Scenario: The user is telling us their leg was injured
...
Scenario: The user is telling us they had keyhole surgery to their leg
Given the user is on page "p-applicant-physical-injury-legs-leg"
And the user answers 'phyinj-122' ("keyhole surgery to leg") to the question 'q-applicant-physical-injuries'
When the user continues 
