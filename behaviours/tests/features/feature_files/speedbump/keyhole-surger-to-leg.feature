...
When the user continues 
Then the user is on page "p-applicant-physical-injuries-legs-leg"

Scenario: The user is telling us they had keyhole surgery to their leg
Given the user is on page "p-applicant-physical-injuries-legs-leg"
And the user answers 'phyinj-122' ("keyhole surgery to lrg") to the question 'q-applicant-physical-injuries-legs-leg-other'
When the user continues 
