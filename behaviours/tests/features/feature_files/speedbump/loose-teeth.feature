...
And the user answers 'mouth' to the question 'q-applicant-physical-injuries-upper-head-other'
When the user continues 
Then the user is on page "p-applicant-physical-injuries-upper-mouth"
...
And the user answers 'phyinj-044' ("loose tooth") to the question 'q-applicant-physical-injuries-upper-mouth-other'
When the user continues 
