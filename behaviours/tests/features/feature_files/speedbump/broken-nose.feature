...
Scenario: The user is telling us they have a broken nose
Given the user is on page "p-applicant-physical-injury-upper-nose"
And the user answers 'phyinj-033' ("broken nose") to the question 'q-applicant-physical-injuries'
When the user continues 
