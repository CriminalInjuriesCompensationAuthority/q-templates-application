...
And selects 'Ear or hearing' to the question 'What parts of the head, face or neck were injured?'
When the user continues 
...
Scenario: The user is telling us they have 1 perforated ear drum
Given the user is on page "p-applicant-physical-injuries-upper-ear"
And selects 'phyinj-009' ("perforated eardrum") to the question 'Select any injuries to the ear or hearing'
When the user continues 
They will be on page "p-applicant-infections"

Scenario: The user is does not select an injury type
Given the user is on page "p-applicant-physical-injuries-upper-ear"
And does not select an answer to the question 'Select any injuries to the ear or hearing'
When the user continues 
They will see the error message 'Select an injury from the list'
