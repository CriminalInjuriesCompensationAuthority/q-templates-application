...
And the user answers 'ear' to the question 'q-applicant-physical-injuries-upper-head-other'
When the user continues 
...
And the user answers 'phyinj-009' ("one-perforated eardrum") to the question 'q-applicant-physical-injuries-upper-ear-other'
When the user continues 
