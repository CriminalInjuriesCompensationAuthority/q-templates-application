Feature: applicant adult sms speedbump surfaced for bruises on arm or hand
...
When the user continues 
Then the user is on page "p-applicant-physical-injuries-arms-arm"
...
When the user continues 
Then the user is on page "p-applicant-physical-injuries-arms-hand"

Scenario: The user is telling us their skin was injured
Given the user is on page "p-applicant-physical-injuries-arms-hand"
And the user answers 'skin' to the question 'q-applicant-physical-injuries-arms-arm-other'
When the user continues 
Then the user is on page "p-applicant-physical-injuries-arms-skin"

Scenario: The user is telling us they have bruises on their hand or arm
Given the user is on page "p-applicant-physical-injuries-arms-skin"
And the user answers 'phyinj-108' ("bruises on arm or hand") to the question 'q-applicant-physical-injuries-arms-skin-other'
When the user continues 
