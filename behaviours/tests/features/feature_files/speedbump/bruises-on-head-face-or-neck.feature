Feature: applicant adult sms speedbump surfaced for bruises on head,face or neck
...
And selects 'skin' to the question 'What parts of the head, face or neck were injured?'
When the user continues 
They will be on page "p-applicant-physical-injuries-upper-skin"
...
Scenario: The user is telling us they have bruises on the head face or neck
Given the user is on page "p-applicant-physical-injuries-upper-skin"
And selects 'phyinj-049'("bruises on head face or neck") to the question 'Select any injuries to the skin on the head face or neck'
When the user continues 
They will be on page "p-applicant-infections"

Scenario: The user is does not select an injury type
Given the user is on page "p-applicant-physical-injuries-upper-skin"
And does not select an answer to the question 'Select any injuries to the skin on the head face or neck'
When the user continues 
They will see the error message 'Select an injury from the list'
