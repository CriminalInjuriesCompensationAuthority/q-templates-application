...
And the user answers 'skin' to the question 'q-applicant-physical-injuries-upper-head-other'
When the user continues 
Then the user is on page "p-applicant-physical-injuries-upper-skin"
...
And the user answers 'phyinj-049'("bruises on head face or neck") to the question 'q-applicant-physical-injuries-upper-skin-other'
When the user continues 
