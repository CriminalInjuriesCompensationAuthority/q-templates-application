@cuts-on-legs-or-feet @speedbump
Feature: applicant adult sms speedbump surfaced for cuts on legs oor feet
...
Scenario: The user is telling us they had cuts on their legs or feet
Given the user is on page "p-applicant-physical-injury-legs-skin"
And the user answers 'phyinj-134' ("cuts on legs or feet") to the question 'q-applicant-physical-injuries'
When the user continues 
