Feature: applicant adult sms speedbump surfaced for cuts on arm or hand
...
Scenario: The user is telling us they have bruises on their hands or arm
Given the user is on page "p-applicant-physical-injuries-arms-skin"
And the user answers 'phyinj-107' ("cuts on arm or hand") to the question 'q-applicant-physical-injuries-arms-skin-other'
When the user continues 
