Feature: applicant adult sms speedbump surfaced for bruises on torso
...
And the user answers 'torso' to the question "q-applicant-physical-injuries"
When the user continues 
They will be on page "p-applicant-physical-injury-torso"

Scenario: The user is telling us their muscle was injured
...
When the user continues 
They will be on page "p-applicant-physical-injuries-torso-muscle"

Scenario: The user is telling us they have a muscle injury on their torso
Given the user is on page "p-applicant-physical-injuries-torso-muscle"
And the user answers 'phyinj-154' ("muscle on torso") to the question 'q-applicant-physical-injuries-torso-muscle-other'
When the user continues 
