Feature: applicant adult sms speedbump surfaced for black eye
...
Scenario: The user is telling us they have a black eye
Given the user is on page "p-applicant-physical-injuries-upper-eye"
And the user answers 'phyinj-051' ("black eye") to the question 'q-applicant-physical-injuries-upper-eye-other'
When the user continues 
