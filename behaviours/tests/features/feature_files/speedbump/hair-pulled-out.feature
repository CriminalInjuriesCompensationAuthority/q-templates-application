@hair-pulled-out @speedbump
Feature: applicant adult sms speedbump surfaced for hair pulled out
...
And the user answers 'phyinj-053' ("hair pulled out") to the question 'q-applicant-physical-injuries'
When the user continues 
