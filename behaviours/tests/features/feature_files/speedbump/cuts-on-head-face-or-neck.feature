Feature: applicant adult sms speedbump surfaced for cuts on head, face or neck
...
Scenario: The user is telling us they have cuts on the head face or neck
Given the user is on page "p-applicant-physical-injuries-upper-skin"
And selects 'phyinj-048' ("cuts on head face or neck") to the question 'Select any injuries to the skin on the head face or neck'
When the user continues 
