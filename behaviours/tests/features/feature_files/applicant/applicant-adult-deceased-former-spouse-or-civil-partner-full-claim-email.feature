@applicant-adult-deceased-former-spouse-or-civil-partner-full-claim-email @legacy @applicant
Feature: applicant:adult.deceased.former spouse or civil partner full claim email
...
And the user answers 'formerSpouseOrCivilPartner' to the question "q-applicant-relationship-to-deceased"
When the user continues
