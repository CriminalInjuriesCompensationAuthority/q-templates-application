@applicant-adult-deceased-living-together @legacy @applicant
...
When the user continues
Then the user is on page "p-applicant-living-apart"

Scenario: the user is on page p-applicant-living-apart.
Given the user is on page "p-applicant-living-apart"
...
And the user answers 'false' to the question "q-applicant-living-together"
When the user continues
Then the user is on page "p-applicant-contact-with-deceased"

Scenario: the user is on page p-applicant-contact-with-deceased.
Given the user is on page "p-applicant-contact-with-deceased"
And the user answers 'occasionally' to the question "q-applicant-contact-with-deceased"
When the user continues
Then the user is on page "p-applicant-contact-more-details"

Scenario: the user is on page p-applicant-contact-more-details.
Given the user is on page "p-applicant-contact-more-details"
...
When the user continues
Then the user is on page "p-applicant-contact-out-of-touch"

Scenario: the user is on page p-applicant-contact-out-of-touch.
Given the user is on page "p-applicant-contact-out-of-touch"
...
When the user continues
Then the user is on page "p-applicant-living-together-duration"

Scenario: the user is on page p-applicant-living-together-duration.
Given the user is on page "p-applicant-living-together-duration"
