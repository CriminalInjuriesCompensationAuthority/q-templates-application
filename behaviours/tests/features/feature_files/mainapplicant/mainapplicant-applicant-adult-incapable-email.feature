@mainapplicant-applicant-adult-incapable-email @legacy @mainapplicant
Feature: mainapplicant:applicant.adult:incapable email
...
Scenario: the user is on the task list
Given the user is on page "p-task-list"
When the user selects the task "t_mainapplicant-authority"
...
Then the user is on page "p-task-list"
And the "t_mainapplicant-authority" task status will be marked as "Completed"
...
Scenario: the user is on the task list
Given the user is on page "p-task-list"When the user selects the task "t_offender_about-the-offender"
