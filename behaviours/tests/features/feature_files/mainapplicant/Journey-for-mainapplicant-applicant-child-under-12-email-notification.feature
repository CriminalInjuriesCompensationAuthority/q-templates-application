@Journey-for-mainapplicant-applicant-child-under-12-email-notification @legacy @mainapplicant
Feature: Journey for mainapplicant:applicant.child:under-12 email notification
