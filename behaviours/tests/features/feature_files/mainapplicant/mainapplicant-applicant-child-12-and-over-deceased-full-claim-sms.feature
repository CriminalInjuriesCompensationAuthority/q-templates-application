@mainapplicant-applicant-child-12-and-over-deceased-full-claim-sms @legacy @mainapplicant
...
And the user answers "31 12 2009" to the question "q-deceased-date-of-birth"
When the user continues
...
When the user continues
hen the user is on page "p-task-list"
...
When the user advances the application
Then the user is on page "p-mainapplicant-declaration-12-and-over-deceased"

Scenario: the user is on page p-mainapplicant-declaration-12-and-over-deceased.
Given the user is on page "p-mainapplicant-declaration-12-and-over-deceased"
