...
And the user answers 'elbow' to the question "q-applicant-physical-injury-arms"
When the user continues
Then the user is on page "p-applicant-physical-injury-arms-elbow"


Scenario: the user is on page p-applicant-physical-injury-arms-elbow.
Given the user is on page "p-applicant-physical-injury-arms-elbow"
And the user answers 'phyinj-086' to the question "q-applicant-physical-injuries"
When the user continues
