...
And the user answers 'muscle' to the question "q-applicant-physical-injury-arms"
When the user continues
Then the user is on page "p-applicant-physical-injury-arms-muscle"


Scenario: the user is on page p-applicant-physical-injury-arms-muscle.
Given the user is on page "p-applicant-physical-injury-arms-muscle"
And the user answers 'phyinj-158' to the question "q-applicant-physical-injuries"
When the user continues
