...
And the user answers 'abdomen' to the question "q-applicant-physical-injury-torso"
When the user continues
Then the user is on page "p-applicant-physical-injury-torso-abdomen"


Scenario: the user is on page p-applicant-physical-injury-torso-abdomen.
Given the user is on page "p-applicant-physical-injury-torso-abdomen"
And the user answers 'phyinj-058' to the question "q-applicant-physical-injuries"
When the user continues
