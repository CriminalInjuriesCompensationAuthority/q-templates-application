...
And the user answers 'mouth' to the question "q-applicant-physical-injury-upper"
When the user continues
Then the user is on page "p-applicant-physical-injury-upper-mouth"


Scenario: the user is on page p-applicant-physical-injury-upper-mouth.
Given the user is on page "p-applicant-physical-injury-upper-mouth"
And the user answers 'phyinj-040' to the question "q-applicant-physical-injuries"
When the user continues
