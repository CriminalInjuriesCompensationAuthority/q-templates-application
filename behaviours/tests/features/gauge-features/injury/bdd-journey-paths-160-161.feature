...
And the user answers 'skin' to the question "q-applicant-physical-injury-upper"
When the user continues
Then the user is on page "p-applicant-physical-injury-upper-skin"


Scenario: the user is on page p-applicant-physical-injury-upper-skin.
Given the user is on page "p-applicant-physical-injury-upper-skin"
And the user answers 'phyinj-001' to the question "q-applicant-physical-injuries"
When the user continues
