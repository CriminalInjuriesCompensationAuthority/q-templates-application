@mainapplicant-applicant-child-under-12-deceased-full-claim-sms @legacy
Feature: mainapplicant.applicant-child-under-12:deceased full claim sms
...
And the user answers '2020' to the question "q-deceased-date-of-birth"
When the user answers the question
...
When the user advances the application
Then the application is in the state "p-mainapplicant-declaration-under-12-deceased"

Scenario: the user is on page p-mainapplicant-declaration-under-12-deceased.
Given the application is in the state "p-mainapplicant-declaration-under-12-deceased"
