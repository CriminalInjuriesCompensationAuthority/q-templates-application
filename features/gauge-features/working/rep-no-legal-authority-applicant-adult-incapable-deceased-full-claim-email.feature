@rep-no-legal-authority-applicant-adult-incapable-deceased-full-claim-email @legacy
Feature: rep-no-legal-authority.applicant-adult-incapable-deceased-full-claim-email
...
When the user advances the application
Then the application is in the state "p-rep-declaration-under-12-deceased"

Scenario: the user is on page p-rep-declaration-under-12-deceased.
Given the application is in the state "p-rep-declaration-under-12-deceased"
