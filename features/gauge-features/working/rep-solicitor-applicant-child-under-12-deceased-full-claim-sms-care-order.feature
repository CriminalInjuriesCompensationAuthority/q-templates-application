@rep-solicitor-applicant-child-under-12-deceased-full-claim-sms-care-order @legacy
Feature: rep.solicitor-applicant.child-under-12:deceased-full-claim-sms care order
...
Given the application is in the state "p-mainapplicant-relationship"
When the user advances the application
And the user answers 'grandfather' to the question "q-mainapplicant-relationship"
When the user answers the question
...
And the user answers 'solicitor organisation' to the question "q-rep-organisation-name"
