@applicant-adult-deceased-parent-funeral-cost-claim-only-sms @legacy
Feature: applicant:adult.deceased.parent funeral cost claim only sms
...
And the user answers 'true' to the question "q-applicant-claim-type"
When the user answers the question
