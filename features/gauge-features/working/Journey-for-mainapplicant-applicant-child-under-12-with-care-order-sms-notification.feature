@Journey-for-mainapplicant-applicant-child-under-12-with-care-order-sms-notification @legacy
Feature: Journey for mainapplicant:applicant.child:under-12-with-care-order sms notification
