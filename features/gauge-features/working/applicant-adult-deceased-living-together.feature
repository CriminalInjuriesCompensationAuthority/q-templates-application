@applicant-adult-deceased-living-together @legacy
Feature: applicant adult deceased living together
...
And the user answers 'spouseOrCivilPartner' to the question "q-applicant-relationship-to-deceased"
When the user answers the question
...
Scenario: the user is on page p-applicant-living-together.
Given the application is in the state "p-applicant-living-together"
And the user answers 'false' to the question "q-applicant-living-together"
When the user answers the question
Then the application is in the state "p-applicant-living-apart"

Scenario: the user is on page p-applicant-living-apart.
Given the application is in the state "p-applicant-living-apart"
When the user advances the application
Then the application is in the state "p-applicant-living-apart"

Scenario: the user is on page p-applicant-living-apart.
Given the application is in the state "p-applicant-living-apart"
And the user answers 'false' to the question "q-applicant-living-apart"
When the user answers the question
...
Given the application is in the state "p-applicant-living-together"
When the user advances the application
Then the application is in the state "p-applicant-contact-with-deceased"

Scenario: the user is on page p-applicant-contact-with-deceased.
Given the application is in the state "p-applicant-contact-with-deceased"
When the user advances the application
Then the application is in the state "p-applicant-contact-with-deceased"

Scenario: the user is on page p-applicant-contact-with-deceased.
Given the application is in the state "p-applicant-contact-with-deceased"
And the user answers 'occasionally' to the question "q-applicant-contact-with-deceased"
When the user answers the question
Then the application is in the state "p-applicant-contact-more-details"

Scenario: the user is on page p-applicant-contact-more-details.
Given the application is in the state "p-applicant-contact-more-details"
When the user advances the application
And the user answers 'something' to the question "q-applicant-contact-more-details"
When the user answers the question
Then the application is in the state "p-applicant-financial-help"
...
Scenario: the user is on page p-applicant-contact-with-deceased.
Given the application is in the state "p-applicant-contact-with-deceased"
And the user answers 'never' to the question "q-applicant-contact-with-deceased"
When the user answers the question
Then the application is in the state "p-applicant-contact-out-of-touch"

Scenario: the user is on page p-applicant-contact-out-of-touch.
Given the application is in the state "p-applicant-contact-out-of-touch"
When the user advances the application
And the user answers 'something' to the question "q-applicant-contact-out-of-touch"
When the user answers the question
Then the application is in the state "p-applicant-financial-help"
...
Scenario: the user is on page p-applicant-relationship-to-deceased.
Given the application is in the state "p-applicant-relationship-to-deceased"
And the user answers 'partner' to the question "q-applicant-relationship-to-deceased"
When the user answers the question
Then the application is in the state "p-applicant-living-together"
...
When the user answers the question
Then the application is in the state "p-applicant-living-together-duration"

Scenario: the user is on page p-applicant-living-together-duration.
Given the application is in the state "p-applicant-living-together-duration"
When the user advances the application
Then the application is in the state "p-applicant-living-together-duration"

Scenario: the user is on page p-applicant-living-together-duration.
Given the application is in the state "p-applicant-living-together-duration"
And the user answers 'true' to the question "q-applicant-living-together-duration"
When the user answers the question
Then the application is in the state "p-applicant-financial-help"
