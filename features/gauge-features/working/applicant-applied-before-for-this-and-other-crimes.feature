@applicant-applied-before-for-this-and-other-crimes @legacy
Feature: applicant applied before for this and other crimes
...
Scenario: the user is on page p-applicant-applied-before-for-this-crime.
Given the application is in the state "p-applicant-applied-before-for-this-crime"
And the user answers 'true' to the question "q-applicant-applied-before-for-this-crime"
When the user answers the question
Then the application is in the state "p--context-you-should-not-apply-again"

Scenario: the user is on page p--context-you-should-not-apply-again.
Given the application is in the state "p--context-you-should-not-apply-again"
When the user advances the application
Then the application is in the state "p--context-you-should-not-apply-again"
...
And the user answers 'reference 123456' to the question "enter-your-previous-reference-number"
When the user answers the question
