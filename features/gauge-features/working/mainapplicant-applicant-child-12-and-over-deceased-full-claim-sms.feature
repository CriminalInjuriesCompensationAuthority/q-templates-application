@mainapplicant-applicant-child-12-and-over-deceased-full-claim-sms @legacy
Feature: mainapplicant.applicant.child-12-and-over:deceased full claim sms
...
When the user answers the question
Then the application is in the state "p-mainapplicant-enter-your-email-address"

Scenario: the user is on page p-mainapplicant-enter-your-email-address.
Given the application is in the state "p-mainapplicant-enter-your-email-address"
...
When the user advances the application
And the user answers 'abcdefghijklmnopqrstuvwxyz abcdefghijklmnopqrstuvwxyz' to the question "q-mainapplicant-relationship"
When the user answers the question
Then the application is in the state "p-mainapplicant-relationship"
...
And the user answers '2009' to the question "q-deceased-date-of-birth"
When the user answers the question
...
When the user answers the question
Then the application is in the state "p-applicant-who-did-you-apply-to"

Scenario: the user is on page p-applicant-who-did-you-apply-to.
Given the application is in the state "p-applicant-who-did-you-apply-to"
When the user advances the application
And the user answers 'no one' to the question "q-applicant-who-did-you-apply-to"
When the user answers the question
Then the application is in the state "p-applicant-has-a-decision-been-made"

Scenario: the user is on page p-applicant-has-a-decision-been-made.
Given the application is in the state "p-applicant-has-a-decision-been-made"
When the user advances the application
Then the application is in the state "p-applicant-has-a-decision-been-made"
...
When the user answers the question
Then the application is in the state "p-applicant-how-much-was-award"

Scenario: the user is on page p-applicant-how-much-was-award.
Given the application is in the state "p-applicant-how-much-was-award"
When the user selects previous page
Then the application is in the state "p-applicant-has-a-decision-been-made"
...
When the user answers the question
Then the application is in the state "p-applicant-when-will-you-find-out"

Scenario: the user is on page p-applicant-when-will-you-find-out.
Given the application is in the state "p-applicant-when-will-you-find-out"
When the user advances the application
Then the application is in the state "p-applicant-when-will-you-find-out"
...
When the user advances the application
Then the application is in the state "p-mainapplicant-declaration-12-and-over-deceased"

Scenario: the user is on page p-mainapplicant-declaration-12-and-over-deceased.
Given the application is in the state "p-mainapplicant-declaration-12-and-over-deceased"
