@mainapplicant-applicant-child-12-and-over-sms @legacy
Feature: mainapplicant:applicant.child:12-and-over sms
...
When the user advances the application
Then the application is in the state "p-mainapplicant-declaration-12-and-over"

Scenario: the user is on page p-mainapplicant-declaration-12-and-over.
Given the application is in the state "p-mainapplicant-declaration-12-and-over"
