@deceased-crime-location-somewhere-else-not-reported-to-police @legacy
Feature: deceased-crime-location-somewhere-else-not-reported-to-police
...
And the user answers 'other names' to the question "q-applicant-what-other-names-have-you-used"
When the user answers the question
...
And the user answers 'ma1' to the question "q-deceased-postcode"
When the user answers the question
...
And the user answers 'offender' to the question "q-offender-enter-offenders-name"
When the user answers the question
