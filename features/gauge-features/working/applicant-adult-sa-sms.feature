@applicant-adult-sa-sms @legacy
Feature: applicant adult sa sms
...
When the user answers the question
Then the application is in the state "p-applicant-enter-your-email-address"

Scenario: the user is on page p-applicant-enter-your-email-address.
Given the application is in the state "p-applicant-enter-your-email-address"
...
Scenario: the user is on page p-applicant-incident-type.
Given the application is in the state "p-applicant-incident-type"
And the user answers 'SEX' to the question "q-applicant-incident-type"
When the user answers the question
...
When the user answers the question
Then the application is in the state "p-applicant-select-infections"

Scenario: the user is on page p-applicant-select-infections.
Given the application is in the state "p-applicant-select-infections"
...
When the user advances the application
Then the application is in the state "p-applicant-pregnancy"

Scenario: the user is on page p-applicant-pregnancy.
Given the application is in the state "p-applicant-pregnancy"
And the user answers 'yes' to the question "q-applicant-pregnancy"
When the user answers the question
