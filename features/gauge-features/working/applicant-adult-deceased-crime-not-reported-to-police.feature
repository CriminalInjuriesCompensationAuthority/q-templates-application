@applicant-adult-deceased-crime-not-reported-to-police @legacy
Feature: applicant:adult.deceased crime not reported to police
...
When the user answers the question
Then the application is in the state "p-applicant-you-cannot-get-compensation"

Scenario: the user is on page p-applicant-you-cannot-get-compensation.
Given the application is in the state "p-applicant-you-cannot-get-compensation"
...
When the user advances the application
And the user answers 'who else is contributing to the funeral costs' to the question "q-applicant-funeral-costs-who-contributed"
When the user answers the question
...
And the user answers 'cardiff' to the question "q-applicant-welsh-town-or-city"
