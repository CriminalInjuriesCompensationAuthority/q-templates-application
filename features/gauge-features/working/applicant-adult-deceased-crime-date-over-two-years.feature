@applicant-adult-deceased-crime-date-over-two-years @legacy
...
And the user answers "2000-01-01T00:00:00.000Z" to the question "q-applicant-when-did-the-crime-happen"
When the user answers the question
...
And the user answers 'nothing' to the question "q-applicant-explain-reason-for-delay-application"
When the user answers the question
