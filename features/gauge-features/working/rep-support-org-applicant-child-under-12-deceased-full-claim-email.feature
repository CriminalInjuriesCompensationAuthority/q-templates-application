@rep-support-org-applicant-child-under-12-deceased-full-claim-email @legacy
Feature: rep.support-org-applicant-child-under-12:deceased-full-claim-email
...
Given the application is in the state "p-mainapplicant-relationship"
When the user advances the application
And the user answers 'SUPP' to the question "q-mainapplicant-relationship"
When the user answers the question
