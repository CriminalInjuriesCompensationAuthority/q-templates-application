@applicant-someone-else-applied-before-for-this-crime @legacy
Feature: applicant someone else applied before for this crime
...
Scenario: the user is on page p-applicant-someone-else-applied-before-for-this-crime.
Given the application is in the state "p-applicant-someone-else-applied-before-for-this-crime"
And the user answers 'yes' to the question "q-applicant-someone-else-applied-before-for-this-crime"
When the user answers the question
