@rep-friend-or-relative-applicant-adult-incapable-deceased-full-claim-email @legacy
Feature: rep-friend-or-relative.applicant-adult-incapable-deceased-full-claim email
...
Scenario: the user is on page p-mainapplicant-relationship.
Given the application is in the state "p-mainapplicant-relationship"
And the user answers 'FRFA' to the question "q-mainapplicant-relationship"
When the user answers the question
