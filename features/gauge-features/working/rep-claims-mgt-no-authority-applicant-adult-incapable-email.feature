@rep-claims-mgt-no-authority-applicant-adult-incapable-email @legacy
Feature: rep-claims-mgt-no-authority:applicant.adult-incapable email
...
When the user answers the question
Then the application is in the state "p--represents-legal-authority"

Scenario: the user is on page p--represents-legal-authority.
Given the application is in the state "p--represents-legal-authority"
...
And the user answers 'CMCO' to the question "q-rep-type"
When the user answers the question
...
And the user answers 'CMCO' to the question "q-rep-first-name"
And the user answers 'mgmt' to the question "q-rep-last-name"
When the user answers the question
...
And the user answers 'claims mgmt organisation' to the question "q-rep-organisation-name"
...
When the user answers the question
Then the application is in the state "p-rep-claims-management-reg"

Scenario: the user is on page p-rep-claims-management-reg.
Given the application is in the state "p-rep-claims-management-reg"
And the user answers 'crn123456' to the question "q-rep-claims-management-reg"
When the user answers the question
...
When the user answers the question
Then the application is in the state "p-applicant-work-details-option"

Scenario: the user is on page p-applicant-work-details-option.
Given the application is in the state "p-applicant-work-details-option"
And the user answers 'other' to the question "q-applicant-work-details-option"
And the user answers 'incapable adult' to the question "q-applicant-work-details-other"
When the user answers the question
...
When the user advances the application
Then the application is in the state "p--download-your-answers"

Scenario: the user is on page p--download-your-answers.
Given the application is in the state "p--download-your-answers"
When the user advances the application
Then the application is in the state "p-rep-declaration-under-12"

Scenario: the user is on page p-rep-declaration-under-12.
Given the application is in the state "p-rep-declaration-under-12"
