@back-navigation-crime-location-routing @legacy
Feature: back-navigation-crime-location-routing
...
When the user answers the question
Then the application is in the state "p-applicant-where-in-england-did-it-happen"

Scenario: the user is on page p-applicant-where-in-england-did-it-happen.
Given the application is in the state "p-applicant-where-in-england-did-it-happen"
And the user answers 'town' to the question "q-applicant-english-town-or-city"
And the user answers 'location' to the question "q-applicant-english-location"
Then the application is in the state "p-applicant-where-in-england-did-it-happen"
...
When the user answers the question
Then the application is in the state "p-applicant-where-in-wales-did-it-happen"

Scenario: the user is on page p-applicant-where-in-wales-did-it-happen.
Given the application is in the state "p-applicant-where-in-wales-did-it-happen"
And the user answers 'town' to the question "q-applicant-welsh-town-or-city"
And the user answers 'location' to the question "q-applicant-welsh-location"
Then the application is in the state "p-applicant-where-in-wales-did-it-happen"
...
Given the application is in the state "p--download-your-answers"
When the user advances the application
Then the application is in the state "p-rep-declaration-12-and-over"

Scenario: the user is on page p-rep-declaration-12-and-over.
Given the application is in the state "p-rep-declaration-12-and-over"
