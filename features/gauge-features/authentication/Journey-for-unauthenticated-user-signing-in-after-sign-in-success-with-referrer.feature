@Journey-for-unauthenticated-user-signing-in-after-sign-in-success-with-referrer @legacy
Feature: Journey for unauthenticated user signing in after sign-in success with referrer
