@Journey-for-unauthenticated-user-signing-in-after-sign-in-with-referrer @legacy
Feature: Journey for unauthenticated user signing in after sign in with referrer
