@Journey-for-unauthenticated-user-signing-in-after-signed-in-with-referrer @legacy
Feature: Journey for unauthenticated user signing in after signed-in with referrer
