@mainapplicant-applicant-child-under-12-email-postcode-lookup @legacy
Feature: mainapplicant.applicant-child-under-12-email postcode lookup
...
Scenario: the user is on page p-applicant-enter-your-address.
Given the application is in the state "p-applicant-enter-your-address"
And the user answers 'find address' to the question "q-applicant-enter-your-address"
And the user answers '1234567' to the question "q-applicant-postcode"
Then the application is in the state "p-applicant-enter-your-address"
...
Scenario: the user is on page p-applicant-enter-your-address.
Given the application is in the state "p-applicant-enter-your-address"
And the user answers 'g412pt' to the question "q-applicant-postcode"
Then the application is in the state "p-applicant-enter-your-address"
...
Given the application is in the state "p-applicant-enter-your-address"
And the user answers 'find address' to the question "q-applicant-enter-your-address"
And the user answers 'tr26 1ah' to the question "q-applicant-postcode"
Then the application is in the state "p-applicant-enter-your-address"
...
And the user answers 'find address' to the question "q-gp-enter-your-address"
And the user answers 'g78 3hj' to the question "q-gp-postcode"
Then the application is in the state "p-gp-enter-your-address"
...
And the user answers 'find address' to the question "q-applicant-dentist-address"
And the user answers 'g78 2ra' to the question "q-applicant-dentist-address-postcode"
Then the application is in the state "p-applicant-dentist-address"
...
Given the application is in the state "p-applicant-dentist-address"
When the user advances the application
Then the application is in the state "p-applicant-medical-help"

Scenario: the user is on page p-applicant-medical-help.
Given the application is in the state "p-applicant-medical-help"
And the user answers 'true' to the question "q-applicant-medical-help"
When the user answers the question
Then the application is in the state "p-applicant-treatment-address"

Scenario: the user is on page p-applicant-treatment-address.
Given the application is in the state "p-applicant-treatment-address"
When the user advances the application
Then the application is in the state "p-applicant-treatment-address"

Scenario: the user is on page p-applicant-treatment-address.
Given the application is in the state "p-applicant-treatment-address"
And the user answers 'find address' to the question "q-applicant-treatment-address"
And the user answers 'g78 3hj' to the question "q-applicant-treatment-postcode"
Then the application is in the state "p-applicant-treatment-address"
...
When the user advances the application
Then the application is in the state "p-applicant-declaration"

Scenario: the user is on page p-applicant-declaration.
Given the application is in the state "p-applicant-declaration"
