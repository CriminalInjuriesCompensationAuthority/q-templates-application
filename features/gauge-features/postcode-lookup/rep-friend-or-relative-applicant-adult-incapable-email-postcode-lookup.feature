@rep-friend-or-relative-applicant-adult-incapable-email-postcode-lookup @legacy
Feature: rep-friend-or-relative.applicant-adult-incapable-email postcode lookup
...
And the user answers 'FRFA' to the question "q-rep-type"
When the user answers the question
...
And the user answers 'mr' to the question "title"
And the user answers 'friendor' to the question "q-rep-first-name"
And the user answers 'relative' to the question "q-rep-last-name"
When the user answers the question
...
And the user answers 'find address' to the question "q-rep-address"
And the user answers 'tr26 1ah' to the question "q-rep-postcode"
Then the application is in the state "p-rep-address"
