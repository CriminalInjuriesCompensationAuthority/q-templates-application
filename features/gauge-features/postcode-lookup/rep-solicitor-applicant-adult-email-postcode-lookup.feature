@rep-solicitor-applicant-adult-email-postcode-lookup @legacy
Feature: rep-solicitor.applicant-adult-email postcode lookup
...
And the user answers 'find address' to the question "q-rep-organisation-address"
And the user answers 'g1 2dt' to the question "q-rep-postcode"
Then the application is in the state "p-rep-organisation-address"
