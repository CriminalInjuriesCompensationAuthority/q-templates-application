...
const applicantFuneralCostsOnly = require('./lib/resource/sections/applicant-claim-type.js');
...
module.exports = {
    ...
    sections: {
        ...
        'p-applicant-claim-type': applicantFuneralCostsOnly.section,
    ...
    routes: {
        ...
        states: {
            ...
            'p-applicant-claim-type': applicantFuneralCostsOnly.route,
