            ...
            translations: [
                {
                    ...
                    <p class="govuk-body">In some cases you may be eligible for compensation for a crime that happened more than 2 years ago if there are exceptional circumstances. For example you could not claim earlier because you mental or physical health stopped you.</p>
                    <p class="govuk-body"><a href="https://www.gov.uk/guidance/criminal-injuries-compensation-a-guide#time-limits-for-applying" class="govuk-link">Find out more about the time limit for applying for compensation (opens in a new tab).</a></p>
                    `,
                                    proxy: `
                    <p class="govuk-body">Based on the information you've given us, the crime happened more than 2 years ago.</p>
                    ...
                    `
                                ...
                                childWhenCrimeHappened: {
                                    ...
                                    <p class="govuk-body">Because of this, you must apply for compensation within either of the following time frames.</p>
                                    <p class="govuk-body"><b>If the crime was reported to the police before you turned 18</b>, you must apply by their 20th birthday.</p>
                                    <p class="govuk-body"><b>If the crime was reported to the police after you turned 18</b>, you must apply within 2 years. This means you need to apply within 2 years of the date of reporting.</p>
        ...
        schema: {
            ...
            properties: {
                ...
                'q-applicant-explain-reason-for-delay-application': {
                    ...
                    type: 'string',
                    description:
                        "You will need to provide supporting evidence for this. We'll let you know how to do this.",
                    maxLength: 2000,
                    errorMessage: {
