                    ...
                    resources: {
                        'compensation-context': {
                            ...
                            'description_someone-else':
                                '<p class="govuk-body">We\'re going to ask about any other compensation or damages the child has been paid for their injuries from any other source.</p><p class="govuk-body">This includes any compensation or damages the child has not already received.</p><p class="govuk-body">This is so we can work out how much compensation the child may receive.</p>'
                        }
                    }
                }
            ]
