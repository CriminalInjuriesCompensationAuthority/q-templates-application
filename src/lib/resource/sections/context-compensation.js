            ...
            translations: [
                {
                    ...
                    resources: {
                        'compensation-context': {
                            description: {
                                myself:
                                    '<p class="govuk-body">We\'re going to ask about any other compensation or damages you are or may be entitled, in connection with this crime.</p><p class="govuk-body">This includes any compensation or damages you\'ve not already received.</p><p class="govuk-body">This is so we can work out how much compensation you may receive from us.</p>',
                                proxy:
