        ...
        schema: {
            ...
            properties: {
                'q-applicant-physical-injuries': {
                    ...
                    items: {
                        anyOf: [
                            {title: 'Muscle', const: 'phyinj-158'},
                            {title: 'Ligament', const: 'phyinj-159'},
                            {title: 'Tendon', const: 'phyinj-160'},
                            {title: 'Cartilage', const: 'phyinj-161'},
            ...
            examples: [{'q-applicant-physical-injuries': ['phyinj-158']}],
            invalidExamples: [
