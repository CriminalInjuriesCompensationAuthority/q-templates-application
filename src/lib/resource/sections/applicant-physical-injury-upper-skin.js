        ...
        schema: {
            ...
            properties: {
                'q-applicant-physical-injuries': {
                    ...
                    items: {
                        anyOf: [
                            {title: 'Cuts', const: 'phyinj-048'},
                            {title: 'Bruises', const: 'phyinj-049'},
                            {title: 'Scars', const: 'phyinj-002'},
                            {title: 'Burns', const: 'phyinj-001'},
            ...
            examples: [{'q-applicant-physical-injuries': ['phyinj-001']}],
            invalidExamples: [
