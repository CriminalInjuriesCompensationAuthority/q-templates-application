            ...
            translations: [
                {
                    ...
                    resources: {
                        'details-context': {
                            ...
                            'title_someone-else': "About the victim's injuries",
                            description:
                            ...
                            'description_someone-else':
                                '<p class="govuk-body">We’re going to ask about any physical injuries caused by the crime.</p><p class="govuk-body">This helps us decide if a payment can be made for any physical injuries.</p><p class="govuk-body">We’ll ask you about the victim\'s mental health later in the application.</p>'
                        }
                    }
                }
            ]
