            ...
            translations: [
                {
                    ...
                    resources: {
                        'q-mainapplicant-shared-responsibility': {
                            ...
                            details: {
                                victim:
                                    '{% from "components/details/macro.njk" import govukDetails %}{{ govukDetails({summaryText: "Help understanding shared parental responsibility",html: \'<p class="govuk-body">There are a wide range of situations where a person holds parental responsibility for a victim.</p><p class="govuk-body">Find out <a class="govuk-link" target="_blank" href="https://www.gov.uk/parental-rights-responsibilities/who-has-parental-responsibility" target="_blank">who has parental responsibility on the UK Government website(opens in new tab)</a>.</p>\'})}}',
                                claimant:
                                    '{% from "components/details/macro.njk" import govukDetails %}{{ govukDetails({summaryText: "Help understanding shared parental responsibility",html: \'<p class="govuk-body">There are a wide range of situations where a person holds parental responsibility for a claimant.</p><p class="govuk-body">Find out <a class="govuk-link" target="_blank" href="https://www.gov.uk/parental-rights-responsibilities/who-has-parental-responsibility" target="_blank">who has parental responsibility (opens in new tab)</a>.</p>\'})}}'
                            },
                            meta: {
                                summary: {
                                    title: {
