    ...
    section: {
        schema: {
            ...
            allOf: [
                {
                    title: 'Declaration',
                    required: ['q-mainapplicant-declaration-under-12'],
                    propertyNames: {
                        enum: ['q-mainapplicant-declaration-under-12']
                    },
                    allOf: [
                        {
                            properties: {
                                'mainapplicant-declaration-under-12': {
                                    description:
                        ...
                        {
                            properties: {
                                'q-mainapplicant-declaration-under-12': {
                                    type: 'array',
                                    items: {
                                        anyOf: [
                                            {
                    ...
                    errorMessage: {
                        required: {
                            'q-mainapplicant-declaration-under-12': 'Select that you agree'
                        }
                    }
                }
            ],
            examples: [
                {
                    'q-mainapplicant-declaration-under-12': ['i-agree']
                }
            ],
            invalidExamples: [
                {},
                ...
                {
                    'q-mainapplicant-declaration-under-12': true
                },
                {
                    'q-mainapplicant-declaration-under-12': 'false'
                },
                {
                    'q-mainapplicant-declaration-under-12': 123
                },
                {
                    'q-mainapplicant-declaration-under-12': [123]
                }
