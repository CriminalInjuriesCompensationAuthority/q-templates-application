    ...
    section: {
            ...
            translations: [
                {
                    ...
                    resources: {
                        ...
                        'help-understanding-care': {
                            description:
                                '{% from "components/details/macro.njk" import govukDetails %}{{ govukDetails({summaryText: "Help understanding care and supervision",html: \'<h2 class="govuk-heading-s">Care</h2><p class="govuk-body">This means you cannot do daily tasks yourself. For example, care may include but is not limited to:</p><ul class="govuk-list govuk-list--bullet"><li>preparing meals</li><li>helping you to eat</li><li>helping you go to the bathroom</li><li>taking medication</li><li>administering other medical treatments</li></ul><h2 class="govuk-heading-s">Supervision</h2><p class="govuk-body">This means you pose a substantial danger to yourself or others without supervision.</p>\'})}}',
        ...
        schema: {
            ...
            properties: {
                ...
                'help-understanding-care': {
                    description: 'l10nt:help-understanding-care.description{?lng,context,ns}'
                }
            },
            errorMessage: {
                required: {
