                    ...
                    resources: {
                        'offender-context': {
                            description: {
                                ...
                                myselfDeceased:
                                    '<p class="govuk-body">We\'re going to ask you the offender\'s name (if you know it).</p><p class="govuk-body">This is so we can make sure the offender would not benefit from any compensation you may be entitled to.</p><p class="govuk-body">We will never contact the offender.</p>'
                            }
                        }
                    }
                }
            ...
            properties: {
                'offender-context': {
                    ...
                    description: [
                        ...
                        'offender-context.description.myselfDeceased',
