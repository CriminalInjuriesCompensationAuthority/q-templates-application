        ...
        schema: {
            ...
            properties: {
                'task-list': {
                    ...
                    description:
                        '{% if isAuthenticated %}Your progress has been saved, you can exit the application and come back to it later.{% else %}You can <a href="/account/sign-in" class="govuk-link">create a GOV.UK One Login</a> to save your application and return to it later.{% endif %}',
                    properties: {
                        taskListInfo: {
                            type: 'object',
                            sections: [
