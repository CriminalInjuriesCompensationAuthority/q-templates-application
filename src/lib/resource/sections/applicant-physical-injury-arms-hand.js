        ...
        schema: {
            ...
            properties: {
                'q-applicant-physical-injuries': {
                    ...
                    items: {
                        anyOf: [
                            {title: 'Broken hand', const: 'phyinj-096'},
                            {title: 'Loss of use of hand', const: 'phyinj-097'},
                            {title: 'Loss of grip', const: 'phyinj-098'},
            ...
            examples: [{'q-applicant-physical-injuries': ['phyinj-096']}],
            invalidExamples: [
