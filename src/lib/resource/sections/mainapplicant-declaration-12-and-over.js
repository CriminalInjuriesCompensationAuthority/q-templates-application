...
module.exports = {
    section: {
        schema: {
            ...
            allOf: [
                {
                    ...
                    errorMessage: {
                        required: {
                            'q-mainapplicant-declaration-12-and-over': 'Select that you agree'
                        }
                    }
                }
            ],
            examples: [
                {
                    'q-mainapplicant-declaration-12-and-over': ['i-agree']
                }
            ],
            invalidExamples: [
                {},
                ...
                {
                    'q-mainapplicant-declaration-12-and-over': true
                },
                {
                    'q-mainapplicant-declaration-12-and-over': 'false'
                },
                {
                    'q-mainapplicant-declaration-12-and-over': 123
                },
                {
                    'q-mainapplicant-declaration-12-and-over': [123]
                }
