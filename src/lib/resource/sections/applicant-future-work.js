        ...
        schema: {
            ...
            properties: {
                'q-applicant-future-work': {
                    type: 'string',
                    title: 'Has their ability to work in future been affected by their injuries?',
                    oneOf: [
                        {
                            title: 'Yes',
                            const: 'yes'
            ...
            errorMessage: {
                required: {
                    'q-applicant-future-work':
                        'Select yes if their ability to work in future has been affected by their injuries'
                }
            },
            examples: [
                {
