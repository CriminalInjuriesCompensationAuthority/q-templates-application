            ...
            translations: [
                {
                    ...
                    resources: {
                        'context-you-should-not-apply-again': {
                            description: {
                                applicant: `<div id="you-should-not-apply-again"> <p class="govuk-body">If you’ve applied before, or someone's applied for you, for injuries related to this crime, we cannot accept another application from you.</p> <h2 class="govuk-heading-m">If you’re waiting to hear from us</h2> <p class="govuk-body">We have your application and are processing it. We'll contact you if we need any more information.</p> <p class="govuk-body">In the majority of cases we make a decision within 12 months, but it can take longer. You may not hear from us during this time, but we are working hard to process your application as quickly as possible.</p><p class="govuk-body">If your information has changed and you need to let us know, you can <a class="govuk-link" href="/contact-us">contact us to update your existing application. </a></p><h2 class="govuk-heading-m">If you applied in the past but were not successful</h2><p class="govuk-body">We cannot accept another application from you, for injuries related to this crime. You should not apply again.</p></p><h2 class="govuk-heading-m">What to do next</h2></p><p class="govuk-body"> If you want to exit this application, you can close this window or tab. You can still continue, if you would like to.</p></div>`,
                                proxy: `<div id="you-should-not-apply-again"> <p class="govuk-body">If you’ve already made an application for the victim, for injuries related to this crime, we cannot accept another application from you.</p> <h2 class="govuk-heading-m">If you’re waiting to hear from us</h2> <p class="govuk-body">We have your application and are processing it. We'll contact you if we need any more information.</p> <p class="govuk-body">In the majority of cases we make a decision within 12 months, but it can take longer. You may not hear from us during this time, but we are working hard to process your application as quickly as possible.</p><p class="govuk-body">If your information or the victim’s information has changed and you need to let us know. You can <a class="govuk-link" href="/contact-us">contact us to update your existing application. </a></p><h2 class="govuk-heading-m">If you applied in the past but were not successful</h2><p class="govuk-body">We cannot accept another application from you, for injuries related to this crime. You should not apply again.</p></p><h2 class="govuk-heading-m">What to do next</h2></p><p class="govuk-body"> If you want to exit this application, you can close this window or tab. You can still continue, if you would like to.</p></div>`
                            }
                        }
                    }
                }
