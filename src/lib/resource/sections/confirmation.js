            ...
            properties: {
                confirmation: {
                    ...
                    description: [
                        ...
                        ['|role.all', 'mainapplicant', 'incapableAdult'],
                        'confirmation.description.mainapplicant.incapableAdult',
                        ['|role.all', 'mainapplicant', 'child'],
                        'confirmation.description.mainapplicant.child',
                        ['|role.all', 'rep', 'adult'],
                        'confirmation.description.rep.adult',
                        ['|role.all', 'rep', 'child'],
                        'confirmation.description.rep.child',
                        ['|role.all', 'rep', 'noAuthority'],
                        'confirmation.description.rep.noAuthority',
                        ['|role.all', 'rep', 'incapableAdult'],
                        'confirmation.description.rep.incapableAdult'
                    ]
                }
            },
            examples: [{}],
